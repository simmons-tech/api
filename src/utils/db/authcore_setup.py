...
room_db = init('room')
allSections = []
allSections.append(('23AB', ['224A', '225', '224B', '244B', '244C', '252', '228', '229', '321', '322B', '322C', '324', '326', '341', '344', '322D', '325', '327', '345', '329', '328', '330']))
allSections.append(('34C', ['337', '340A', '340B', '379A', '371', '381', '372', '373', '374', '375', '376', '377', '378', '379B', '380', '438', '440', '472', '473', '474', '475', '476', '477', '478', '479A', '479B']))
allSections.append(('4AB', ['421C', '422B', '424A', '428', '446', '421B', '422C', '424B', '426', '427', '447', '448', '433', '451', '464', '467', '429', '450', '452', '465', '466']))
allSections.append(('5AB', ['521C', '522B', '524', '548', '521B', '522C', '525', '526', '527C', '543', '544', '545', '549A', '549B', '533', '553', '532', '534', '535', '550', '551', '552', '564', '565', '566', '569']))
allSections.append(('6AB', ['627', '645B', '624A', '624B', '625', '626', '643', '644', '645A', '647', '648', '649', '650', '652', '664', '628', '629', '631B', '631C', '631D', '632', '633', '653', '665', '667']))
allSections.append(('56C', ['537', '575', '573', '574', '577', '578A', '578B', '538', '539', '540', '570', '571', '572A', '572B', '634', '635', '675', '636', '637', '638', '639', '640', '670', '672', '673', '674', '678']))
allSections.append(('7ABC', ['721', '724', '741A', '725', '727', '728', '743', '744', '746', '747', '748C', '741B', '729', '732', '733', '730', '731', '748B', '738B', '780', '778', '776', '779', '739', '775', '740', '738C']))
allSections.append(('8910A', ['824', '821', '846', '825', '924', '921C', '922C', '921B', '945', '922D', '925', '946', '1024', '1021D', '1022B', '1021C', '1045', '1022C', '1044', '1025', '1043', '1046', '1021A']))
allSections.append(('8910B', ['832', '866', '833', '871','865', '872', '932', '971', '931', '933', '966', '972', '936', '1036', '1052A', '1064', '1032', '1066', '1072', '1033', '1052B', '1065', '1031B', '1034', '1031C']))
allSections.append(('8910C', ['840', '878', '839', '873', '874', '875', '939', '978', '940', '941', '974', '973', '977', '979', '976', '938', '975', '1078B', '1040', '1039', '1073', '1074', '1076', '1077', '1038', '1078A', '1075']))

for section in allSections:
    newsection = Section()
    newsection.label = section[0]
...
for num in allRooms:
    if num in listOfBostonSideRooms:
        allRooms[num].view = 'Boston'
    elif num in listOfCambridgeSideRooms:
        allRooms[num].view = 'Cambridge'
...
for entry in listOfTopsAndLefts:
    allRooms[entry[0]].Y = entry[1]
    allRooms[entry[0]].X = entry[2]
...
for num in allRooms:
    if num in listOfMinorCurvyWalls:
        allRooms[num].hasCurvyWall = "Minor"
    if num in listOfMajorCurvyWalls:
        allRooms[num].hasCurvyWall = "Major"
    if num in listOfAwfulCurvyWalls:
        allRooms[num].hasCurvyWall = "Awful"
